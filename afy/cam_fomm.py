...
if __name__ == "__main__":
    ...
    # cap = cv2.VideoCapture('/home/ayush-ai/Music/avatarify/avatarify/input/ali.mp4')
    # cap = cv2.VideoCapture('/home/ayush-ai/Music/avatarify/avatarify/input/input.mp4')
    cap = cv2.VideoCapture('/home/ayush-ai/Music/avatarify/avatarify/ahmad/DLIB/driving _video/input_video_1.mp4')
    # cap.start()
    fourcc = cv2.VideoWriter_fourcc(*'mp4v')
    output_vid = cv2.VideoWriter('./output/output2.mp4', fourcc, 25, (256, 256))
